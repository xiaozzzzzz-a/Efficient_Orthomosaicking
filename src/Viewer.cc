...
void Viewer::Run()
{
    ...
    pangolin::CreateWindowAndBind("Real-Time  UAV Orthomosaic: Map Viewer",1024,768);
    ...
    Ow.SetIdentity();
    cv::namedWindow("Real-Time UAV Orthomosaic: Current Frame");
    ...
    while(1)
    {
        ...
        cv::imshow("Real-Time UAV Orthomosaic: Current Frame",toShow);
        cv::waitKey(mT);
