...
// Flag to activate the measurement of time in each process (track,localmap, place recognition).#define REGISTER_TIMES
...
namespace ORB_SLAM3 {
    ...
    public:
        ...
        float gpsSigmaXY() {return gpsSigmaXY_;}
        float gpsSigmaZ() {return gpsSigmaZ_;}
        int globalAlignInitFrames() {return globalAlignInitFrames_;}
        int globalAlignFinishMeasurements() {return globalAlignFinishMeasurements_;}
    ...
    private:
        ...
        float gpsSigmaXY_;
        float gpsSigmaZ_;
        int globalAlignInitFrames_;
        int globalAlignFinishMeasurements_;
