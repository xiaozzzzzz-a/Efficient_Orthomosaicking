...
#include "map2DFusion/MultiBandMap2DCPU.h"
...
public:
    ...
    void static LocalBundleAdjustmentWithGlobalMeas(KeyFrame *pKF, bool *pbStopFlag, Map *pMap, int &num_fixedKF, int &num_OptKF, int &num_MPs, int &num_edges);
